...
input_dir="/users/abaud/komar/P50/allocoprophagy/output/illum_all_meta/Rnor_6.0_alignments/paired"
output_file="/users/abaud/komar/P50/allocoprophagy/output/illum_all_meta/counts/paired_mapped_read_counts.txt"
