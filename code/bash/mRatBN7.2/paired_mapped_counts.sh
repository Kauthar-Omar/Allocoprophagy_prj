...
output_file="/users/abaud/komar/P50/allocoprophagy/output/metagenomes/counts/paired_mapped_mRatBN7.2_read_counts.txt"


# Loop over all the BAM files in the input directory
for bam_file in "$input_dir"/*_paired.bam
do
