...
DATA="/users/abaud/komar/P50/allocoprophagy/output/all_meta/trimming/unpaired"

# OUT: output folder for alignemnt - UNPAIRED
OUT="/users/abaud/komar/P50/allocoprophagy/output/all_meta/Rnor_6.0_alignments/unpaired"
mkdir -p $OUT
