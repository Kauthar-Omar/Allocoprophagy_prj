...
#Run PLINK
OUT="/users/abaud/komar/P50/allocoprophagy/output/genotypes/all_cecum_whole_genotypes/"
...
plink --vcf $gen_file --keep-fam ${IN}sample_whole_cecum.txt --chr ${SGE_TASK_ID} --keep-allele-order --real-ref-alleles --make-bed --out ${OUT}hs_rats_n24_chr${SGE_TASK_ID}
