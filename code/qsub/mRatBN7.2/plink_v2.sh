...
#Run PLINK
OUT="/users/abaud/komar/P50/allocoprophagy/output/genotypes/32_rats/"
...
plink --vcf $gen_file --chr ${SGE_TASK_ID} --keep-allele-order --real-ref-alleles --make-bed --out ${OUT}hs_rats_n32_chr${SGE_TASK_ID}
