...
COUNT_ALL="$OUT_DIR/readcount/all_cecum_whole/flow_cell_2_corrected" #NB: WTO final /
SS="$OUT_DIR/sample_summaries/all_cecum_whole/flow_cell_2_corrected/" #NB: NEED final /
mkdir -p $SS
