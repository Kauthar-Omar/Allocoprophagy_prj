#!/bin/bash
#$ -cwd 
#$ -N broman_sample_summaries_wc_f1
...
COUNT_ALL="$OUT_DIR/readcount/all_cecum_whole/flow_cell_1" #NB: WTO final /
SS="$OUT_DIR/sample_summaries/cecum_whole/flow_cell_1/" #NB: NEED final /
mkdir -p $SS
