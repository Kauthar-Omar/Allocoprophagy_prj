#!/bin/bash
#$ -cwd 
#$ -N broman_sample_summaries_sc_f1
...
COUNT_ALL="$OUT_DIR/readcount/cecal_squeezed/flow_cell_2_corrected" #NB: WTO final /
SS="$OUT_DIR/sample_summaries/cecal_squeezed/flow_cell_2_corrected/" #NB: NEED final /
mkdir -p $SS
...
#qsub broman_sample_summaries_wc_fc1.sh 
