...
PUP_DIR="$OUT_DIR/pileup" # PILEUPS
GENO_DIR="/users/abaud/komar/P50/allocoprophagy/output/genotypes/genotype_positions" # GENOTYPED POSITIONS
...
COUNT_DIR="$OUT_DIR/readcount/${SAMPLE}"
mkdir -p $COUNT_DIR
